// ===========================================================
// IRONCLAD — CONFIGURAÇÃO DO CHATBOT TYPEBOT
// Preencha somente estes 2 campos quando tiver seu chatbot.
// Exemplo de src: https://seu-typebot.com.br/seu-bot
// ===========================================================
const TYPEBOT_TITLE = "TÍTULO DO CHATBOT";
const TYPEBOT_SRC = "COLE_AQUI_SEU_SRC_TYPEBOT";
...
const typebotFrame = document.getElementById('typebotFrame');
...
function configureChatbot() {
  chatbotTitle.textContent = TYPEBOT_TITLE || 'IronClad Assistant';
  typebotFrame.title = TYPEBOT_TITLE || 'IronClad Assistant';
  const validSrc = TYPEBOT_SRC && !TYPEBOT_SRC.includes('COLE_AQUI') && /^https?:\/\//i.test(TYPEBOT_SRC);
  if (validSrc) {
    typebotFrame.src = TYPEBOT_SRC;
    typebotFrame.style.display = 'block';
    chatbotPlaceholder.style.display = 'none';
  } else {
    typebotFrame.style.display = 'none';
